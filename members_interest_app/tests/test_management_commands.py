...
class TestRunUnpackSaveMembersDataCommand(TestCase):
    ...
    @patch('members_interest_app.utils.unpack_save_members_data.unpack_save_members_data')
    def test_management_command_output(self, mock_unpack_save_members_data):
        ...
        mock_unpack_save_members_data.return_value = "Total members added: 1, Total members updated: 0, Total errors: 0"
