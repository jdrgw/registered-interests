...
class TestIntegrationCallRegisteredInterestAPI(TestCase):
    ...
    def test_integration_call_api_and_append_data(self, mock_api_ids):
        ...
        try:
            ...
            result = call_api_and_save_data(temp_file_path)
            ...
            with open(temp_file_path, "r", encoding="utf-8") as f:
                ...
                assert sum(1 for line in lines if '"href": "/Members/1/Interests"' in line) == 1
                ...
                assert sum(1 for line in lines if '"href": "/Members/2/Interests"' in line) == 1
