...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('file_name', type=str, help='The name of the JSON file containing MP data, not the filepath')

    def handle(self, *args, **kwargs):
        file_name = kwargs['file_name']  # Access the file_name passed from the command line
        try:
