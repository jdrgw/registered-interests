...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('file_path', type=str, help='Path to the JSON file containing registered interest data')
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f'Data processing completed successfully! {records_created} records were inserted.'))
